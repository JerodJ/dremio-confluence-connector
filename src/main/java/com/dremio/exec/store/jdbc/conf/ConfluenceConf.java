...
@SourceType(value = "ConfluenceARP", label = "Confluence",uiConfig = "confluence-layout.json")
public class ConfluenceConf extends AbstractArpConf<ConfluenceConf> {
  private static final String ARP_FILENAME = "arp/implementation/confluence-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.confluence.ConfluenceDriver";
